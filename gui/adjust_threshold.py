...
class Window_Adjust_Threshold:
    ...
    def __init__(self):
        ...
        self.path_json_file = fr'{self.window_dir}\{self.name_directory}\{self.name_subdirectory_json}\{self.name_json_file}'
    ...
    def create_trackBars(self):
        ...
        cv2.createTrackbar('LOW B/H', self.window_name, min_threshold, max_threshold, self.get_trackbar_parameters)
        cv2.createTrackbar('HIGH B/H', self.window_name, min_threshold, max_threshold, self.get_trackbar_parameters)
        cv2.createTrackbar('LOW G/S', self.window_name, min_threshold, max_threshold, self.get_trackbar_parameters)
        cv2.createTrackbar('HIGH G/S', self.window_name, min_threshold, max_threshold, self.get_trackbar_parameters)
        cv2.createTrackbar('LOW R/V', self.window_name, min_threshold, max_threshold, self.get_trackbar_parameters)
        cv2.createTrackbar('HIGH R/V', self.window_name, min_threshold, max_threshold, self.get_trackbar_parameters)
